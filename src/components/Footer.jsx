            ...
            <ul className="sub_menu">
              <li>
                <div className="change_country_container">
                  <button
                    href="https://www.trendyol.com/en/select-country?cb=/en"
                    className="change_country_btn"
                  >
                    Ülke Seç
                    <img src={right_icon} />
                  </button>
            ...
            <ul className="sub_menu">
              <li className="sub_menu_item">
                <div className="security_certificate_links_container">
                  <a
                    target="blank"
                    href="https://www.eticaret.gov.tr/siteprofil/305B30787EA6409BBF6EFBEA3D437B96/wwwtrendyolcom"
                  >
                    <img
                      className="security_certificate_image"
                      alt="ETBİS Sertifikası ikonu"
                      src={security_certification1}
                    />
                  </a>
                  <a
                    target="blank"
            ...
            <ul className="sub_menu">
              <li className="sub_menu_item">
                <div className="mobile_app_links_container">
                  <a
                    target="blank"
                    className="mobile_app_link"
                    href="https://apps.apple.com/tr/app/trendyol-fashion-trends/id524362642"
                  >
                  ...
                  >
                    <img
                      className="mobile_app_image"
                      src={footer_google_play}
                    />
                  </a>
                  <a
                    target="blank"
                    className="mobile_app_link"
                    href="https://appgallery.huawei.com/app/C101645013"
                  >
                    <img
                      className="mobile_app_image"
                      src={footer_app_gallery}
                    />
                  </a>
                </div>
              </li>
